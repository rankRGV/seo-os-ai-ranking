...
function commandCenter(){
  ...
  }).join('')}</div>` : '<div class="muted health-trend-empty" style="font-size:13px">Health trend will appear after 2+ daily pulls.</div>';
